...
<div class="dtree">
	...
	<script type="text/javascript">
       ...
       */
		...
		d.add('010203','0102','三级类别','','','mainFrame');
		d.add('01020301','010203','演职人员','${pageContext.request.contextPath}/AdminCreditsServlet?method=findCredits','','mainFrame');
		d.add('01020302','010203','电影类型','${pageContext.request.contextPath}/AdminTypeServlet?method=findAllType','','mainFrame');
		d.add('01020303','010203','电影年代','${pageContext.request.contextPath}/AdminYearServlet?method=findAllYear','','mainFrame');
		d.add('01020304','010203','电影所属区域','${pageContext.request.contextPath}/AdminAreaServlet?method=findArea','','mainFrame');
		d.add('0104','01','电影管理');
		d.add('010401','0104','电影管理','${pageContext.request.contextPath}/AdminProductServlet?method=findAllProductWithPage&currentPage=1','','mainFrame');
		d.add('0105','01','影院管理');
