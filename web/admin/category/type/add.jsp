...
<form id="toForm" class="form-inline" method="post"
      action="${pageContext.request.contextPath}/AdminTypeServlet?method=addType">
    <div class="form-group ">
        <label for="exampleInputName2" class="h4">类型名:</label>
        ...
        <a href="${pageContext.request.contextPath}/AdminTypeServlet?method=findAllType"><button type="button" class="btn btn-default" id="goBack">返回</button></a>
