...
<form id="toForm" class="form-inline" method="post"
      action="${pageContext.request.contextPath}/AdminTypeServlet?method=editType">
    <div class="form-group ">
        <label for="exampleInputName2" class="h4">类别名:</label>
        <input type="hidden" name="id" value="${type.id}">
        <input type="text" class="form-control h5" id="exampleInputName2" name="name" value="${type.name}">
